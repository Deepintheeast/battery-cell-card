...
//        cfg.background_color = cfg.background_color ?? "rgba(0,0,0,0.65)";
        cfg.background_color = cfg.background_color ?? "var(--ha-card-background, #ffffff)";
        cfg.background_opacity = cfg.background_opacity ?? 1.0;
//
        ...
        cfg.cell_unit = cfg.cell_unit ?? 'auto';
...
//        root.style.background = this._config.background_color;
	root.style.background =
	    ...
	    'var(--ha-card-background, var(--card-background-color, rgba(0,0,0,0.65)))';
//	
